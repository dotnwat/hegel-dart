...
///
/// Until the runner lands, this is how a generator is exercised the way a
/// property will exercise it: a whole run of the engine's own choosing, one
/// public handle per case, rather than a single hand-made draw. A generator
/// that holds on the first case and not the fiftieth is the failure mode
/// worth catching, and only a run catches it.
library;
...
///
/// Every case is reported valid: these runs are about what generators do, not
/// about what a property concludes.
void driveCases(
  Libhegel session,
